...
- 「搭配詞」只顯示通過結構與詞性篩選的短語；沒有安全短搭配的詞條會另外顯示完整雙語「句型練習」，不把整句誤稱為搭配詞
- 手機與桌面響應式介面
...
當 WordNet 沒有可安全發布的短搭配詞時，句型練習會從本站已載入的完整雙語例句中選取，英文與中文分開保留，並在介面中明確標示為句型而非搭配詞。句型選取與中文提示均屬自動整理，不能取代人工語感校對。
